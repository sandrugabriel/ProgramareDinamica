...
*/
        ...
        {
            foreach (var item in functii.AllPossibleFBT(3))
            {
                    Console.WriteLine(item.val.ToString());
            }
        }
...
*/
        public void solutia2()
        {
            ...
            Console.WriteLine(functii.MinPathCost(grid,moveCost));
        }
...
Output: 2*/
        public void solutia3() {
            ...
            Console.WriteLine(functii.MaxUncrossedLines(nums1,nums2));
...
Explanation: The compatibility score of any student-mentor pair is 0.*/
        public void solutia4()
        {
            ...
            Console.WriteLine(functii.MaxCompatibilitySum(students,mentors));
        }
 ...
 */
        public void solutia5()
        {
            ...
            Console.Write(functii.LongestStrChain(words));
        }
 ...
 Output: 1*/
        ...
        {
            Console.WriteLine(functii.NumTrees(5));
        }
 ...
 */
        ...
        {
            Console.WriteLine(functii.NumRollsToTarget(30,30,500));
 ...
 */
        ...
        {
            Console.WriteLine(functii.IntegerBreak(2));
        }
 ...
 */
        ...
        {
            Console.WriteLine(functii.FindLongestChain([[1, 2], [2, 3], [3, 4]]));
        }
 ...
 */
        ...
        {
            Console.WriteLine(functii.MaxAbsoluteSum([1, -3, 2, 3, -4]));
        }
